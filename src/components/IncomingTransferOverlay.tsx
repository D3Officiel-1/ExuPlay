    ...
    <AnimatePresence>
      {activeTransfer && (
        <motion.div
          ...
          className="fixed inset-0 z-[10000] bg-background/90 backdrop-blur-3xl overflow-y-auto"
        >
          ...
          <div className="min-h-full w-full flex flex-col items-center justify-center p-6 sm:p-12 relative z-10">
            <motion.div
              ...
              className="space-y-10 max-w-sm w-full text-center py-10"
            >
              ...
              <div className="space-y-4">
                ...
                <div className="p-8 sm:p-10 bg-primary/5 rounded-[3.5rem] border border-primary/10 shadow-inner relative overflow-hidden group">
                  <motion.div 
                    animate={{ x: ["-100%", "200%"] }}
