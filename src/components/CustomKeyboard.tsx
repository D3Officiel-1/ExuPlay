...
const RAW_NATURE = "🐶🐱🦁🐯🦊🐻🐼🐨🐸🦄🐉🦖🐳🐙🦋🐝🌸🔥🌵🌴🪐🌈🍄 Tornado 🌊🌍☀️🌙⭐⚡✨";
const RAW_FOOD = "🍎🍌🍉🍓🥑🍕🍔🍟🌮🍣🍦🍰🍩 popcorn 🍺🍷☕🥐🥨🧀🥚🍭🍱🍙🍜🍛";
...
function KeyboardEmoji({ emoji, hex, onClick }: { emoji: string, hex: string, onClick: (char: string) => void }) {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center aspect-square rounded-xl bg-primary/5 hover:bg-primary/10 transition-all p-1 group overflow-hidden"
    >
      {stage === 'text' ? (
